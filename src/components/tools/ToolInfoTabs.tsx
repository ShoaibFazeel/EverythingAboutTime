...
const ToolInfoTabs: React.FC<ToolInfoTabsProps> = ({ description, howToUse }) => {
  ...
  return (
    <div className="mt-16 max-w-4xl mx-auto border-t border-primary/10 pt-16 animate-in fade-in slide-in-from-bottom-4 duration-700">
      <div className="flex flex-col space-y-8">
        <div className="flex justify-center">
          <div className="inline-flex p-1 bg-primary/5 rounded-2xl backdrop-blur-sm border border-primary/10">
            {tabs.map((tab) => (
              <button
                key={tab.id}
        ...
        <div className="glass rounded-3xl p-8 md:p-12 shadow-sm min-h-[300px] transition-all duration-500">
          <div
